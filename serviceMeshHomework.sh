...
export SUBDOMAIN_BASE=cluster-sodim-66de.sodim-66de.example.opentlc.com
...
# Bookinfo pods don't have curl, so this function is not invoked because the probes always would fail.
#configureProbes
